    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="d-flex justify-content-center gap-4">
                <a href="/reviews/create/<?= $product->id ?>" class="link-review mt-4">Adauga o recenzie</a>
                <a href="/reviews/show/<?= $product->id ?>" class="link-review mt-4">Afiseaza recenziile</a>
            </div>
